        ...
        <div class="card-body">
		        ...
		        <table class="jsgrid-table">
		            <tbody>
		                ...
		                <?php 
		                $i=1;
		                foreach($galleryphoto->result() as $row): ?>
		                <tr class="jsgrid-row">
		                    <td class="jsgrid-cell"><?php echo $i; ?></td>
		                    <td class="jsgrid-cell"><img id="blah" src="./img/product/morephotos/<?php echo $row->photo; ?>" style="width:100px;height:auto;padding-bottom:10px;" /></td>
		                    
		                    <td class="jsgrid-cell"><a href="Admin/delete_productphotos/<?php echo $row->id; ?>" onclick="return confirm('Are you sure to delete?')"><input class="jsgrid-button jsgrid-delete-button" type="button" title="Delete"></a>
		                    </td>
		                </tr>
		                    <?php 
		                   $i++;
