<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            <h5>Products Remark</h5>
        </div>
        <div class="card-body">
            <div class="btn-popup pull-right">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal">Add Remark</button>
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title f-w-600" id="exampleModalLabel">Add Product Remark</h5>
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form">
                                            <div class="form-group">
                                                <label for="validationCustom01" class="mb-1">Remark :</label>
        ...
        <table class="jsgrid-table">
            <tbody>
                <tr class="jsgrid-header-row">
                    ...
                    <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 50px;">Remark</th>
