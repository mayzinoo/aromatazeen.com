		...
		<div class="row padding_md">
			...
			<div class="col-md-9">
				...
				<ul>
				    ...
				    <li>vIf there is no product available for exchange, a coupon of the credit amount will be given to the customer, after deducting the charges for courier and COD handling. That coupon can be used within three months to shop at aromatazeen.com (Applies only to orders within Pakistan)*</li>
				    <li>•	We accept no cancellation of online orders that are customized.</li>
				</ul>
				<p>We don’t accept the cancellation of online orders that are urgent</p>
			</div>
